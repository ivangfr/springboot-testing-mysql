...
class UserResponseTests {
  ...
  @Autowired private JacksonTester<UserResponse> jacksonTester;

  @Test
  void testSerialize() throws IOException {
    UserResponse userResponse =
        new UserResponse(1L, "ivan", "ivan@test", LocalDate.parse("2018-01-01"));
    ...
    assertThat(jsonContent)
        ...
        .isEqualTo(userResponse.id().intValue());
  ...
  void testDeserialize() throws IOException {
    String content =
        "{\"id\":1,\"username\":\"ivan\",\"email\":\"ivan@test\",\"birthday\":\"2018-01-01\"}";
